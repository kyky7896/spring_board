...
public class BoardAspect {
	...
	@Pointcut("execution(* com.example.controller.BoardController.edit(..))"
			+ "||execution(* com.example.controller.BoardController.delete(..))"
			+ "||execution(* com.example.controller.BoardController.update(..))")
	private void check() {
	}
